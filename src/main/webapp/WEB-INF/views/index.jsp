			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro">
						<h1>David Park's<br />
						 Fisrt Board</h1>
						<p>The first board by Spring <br />
						with fully responsive HTML5 + CSS3.</p>
						<ul class="actions">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo">David Park</a>
					</header>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
							...
							<li><a href="/photo_preview">Photo Preview</a></li>
